...
class SceneFileParser {
    ...
    ////////////////////////////////////////////////////////
    parseCameraXML() {
        let camElm = getElm(this.file, "Camera");
    ...
    parseSquaresXML(sqSet) {
        let elm = getElm(this.file, "Square");
    ...
    ////////////////////////////////////////////////////////
    parseCameraJSON() {
        let camElm = this.file.Camera;
        let cx = camElm.Center[0];
        let cy = camElm.Center[1];
        let w = camElm.Width;
